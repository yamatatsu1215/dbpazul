...
export default function VideoCallApp() {
  ...
  const participants = [
    { id: 1, name: "You", avatar: "/placeholder.svg?height=40&width=40", isSpeaking: true },
    { id: 2, name: "Alex Johnson", avatar: "/placeholder.svg?height=40&width=40", isSpeaking: false },
    { id: 3, name: "Maria Garcia", avatar: "/placeholder.svg?height=40&width=40", isSpeaking: false },
    { id: 4, name: "Hiroshi Tanaka", avatar: "/placeholder.svg?height=40&width=40", isSpeaking: false },
  ]

  const messages = [
    { id: 1, sender: "Alex Johnson", text: "Hello everyone!", time: "10:01" },
    { id: 2, sender: "Maria Garcia", text: "Hi Alex, how are you?", time: "10:02" },
            ...
            <Grid item xs={12} sm={6} md={6} key={participant.id}>
              ...
              >
                ...
                >
                  ...
                  {!micOn && participant.id === 1 && <MicOff fontSize="small" sx={{ color: "white", mr: 1 }} />}
                </Box>
              </Paper>
            </Grid>
          ))}
      ...
      >
        <IconButton
          ...
          sx={{
            ...
            "&:hover": { bgcolor: micOn ? "rgba(0, 0, 0, 0.04)" : "rgba(244, 67, 54, 0.2)" },
          }}
        >
        ...
        <IconButton
          ...
          sx={{
            ...
            "&:hover": { bgcolor: videoOn ? "rgba(0, 0, 0, 0.04)" : "rgba(244, 67, 54, 0.2)" },
          }}
        >
        ...
        <IconButton
          ...
          sx={{
            ...
            "&:hover": { bgcolor: screenSharing ? "rgba(76, 175, 80, 0.2)" : "rgba(0, 0, 0, 0.04)" },
          }}
        >
        ...
        <IconButton
          ...
          sx={{
            ...
            "&:hover": { bgcolor: sidebarOpen ? "rgba(33, 150, 243, 0.2)" : "rgba(0, 0, 0, 0.04)" },
          }}
        >
          {tabValue === 0 ? (
                ...
                >
                  <Paper
                    ...
                    sx={{
                      p: 1.5,
                      maxWidth: "80%",
                      bgcolor: msg.sender === "You" ? "primary.light" : "background.paper",
                  ...
                  >
                    ...
                    <Typography
                      variant="caption"
                      color={msg.sender === "You" ? "rgba(255,255,255,0.7)" : "text.secondary"}
            ...
            {participants.map((participant) => (
              <ListItem key={participant.id}>
                ...
                <ListItemText
                  ...
                  secondary={participant.isSpeaking ? "Speaking" : "Not speaking"}
                />
                {participant.id !== 1 && (
